...
report 'ChangeFailureRate copy 2', {
  definition = '''{
    "size": 0,
    "query": {
        "bool": {
    ...
    "aggregations": {
        "single_metric_bucket": {
            ...
            "aggregations": {
                ...
                "output_metric_current_unsuccessful_deployments": {
                    "sum_bucket": {
                        "buckets_path": "current_interval>unsuccessful_deployments"
                    }
                },
                "output_metric_past_unsuccessful_deployments": {
                    "sum_bucket": {
                        "buckets_path": "past_interval>unsuccessful_deployments"
                    }
                },
                ...
                "output_metric_current_percent": {
                    "bucket_script": {
                        "buckets_path": {
                            "unsuccessfulCount": "output_metric_current_unsuccessful_deployments",
                            "totalCount": "output_metric_current_total_deployments"
                        },
                        "script": "params.unsuccessfulCount / params.totalCount * 100",
                ...
                "output_metric_past_percent": {
                    "bucket_script": {
                        "buckets_path": {
                            "unsuccessfulCount": "output_metric_past_unsuccessful_deployments",
